...
The function reports the original coefficients, debiased coefficients, standard error, confidence intervals and p-values. These p-values are already adjusted for the selection process of the lasso, and provide valid inference.
